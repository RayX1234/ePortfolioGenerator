...
public class StartupConstants {
    ...
    public static String ICON_LOAD_PORTFOLIO = "loadPortfolio.png";
    public static String ICON_SAVE_PORTFOLIO = "savePortfolio.png";
    ...
    public static String CSS_CLASS_EPG_PANE = "epg_pane";
